...
// ==============================================================
`timescale 1ns/1ps
module rtl_add_seq_kernel_control_s_axi
#(parameter
...
// 0x2c : reserved
// 0x30 : Data signal of base_add
//        bit 31~0 - base_add[31:0] (Read/Write)
// 0x34 : reserved
...
localparam
    ...
    ADDR_BASE_ADD_DATA_0 = 6'h30,
    ADDR_BASE_ADD_CTRL   = 6'h34,
    WRIDLE               = 2'd0,
    WRDATA               = 2'd1,
    WRRESP               = 2'd2,
    WRRESET              = 2'd3,
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_BASE_ADD_DATA_0: begin
                    rdata <= int_base_add[31:0];
                end
            endcase
        end
    end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_BASE_ADD_DATA_0)
            int_base_add[31:0] <= (WDATA[31:0] & wmask) | (int_base_add[31:0] & ~wmask);
    end
end
